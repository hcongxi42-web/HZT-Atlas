...
export const batteryData: IndustryData = {
  ...
  overviewSummary: `锂电池是新能源革命的"心脏"。电动车能跑 500 公里、手机能撑一整天、电网能把中午的太阳能存到晚上用——全靠锂电。中国锂电产业用了十年时间从跟跑到全球领跑，宁德时代、比亚迪的电池装在全球三分之二的电动车上。

从澳大利亚/南美的锂矿到中国的碳酸锂工厂，从正极/负极/电解液/隔膜四大材料到电池芯制造，再到装车和储能，这是一条中国掌控最完整、技术最领先的产业链。`,
  overviewArchitecture: `本图谱按照"上游→中游→下游"三层架构组织：

• 上游——矿产资源：锂矿（锂辉石、盐湖卤水）是电池的"盐"，全球储量集中在澳洲和南美；镍钴锰是三元正极的关键原料；磷矿是磷酸铁锂正极的原料
• 中游——关键材料：碳酸锂和氢氧化锂是正极的原料；正极材料（三元/磷酸铁锂）决定电池能量密度和安全性；负极材料（石墨/硅基）是锂离子的"停车场"；电解液是锂离子的"游泳池"；隔膜是正负极的"安全隔离带"
• 下游——电池制造与回收：动力电池（车用）是最大市场；储能电池是增长最快的新市场；消费电子电池是传统基本盘；电池回收是闭环的最后一环`,
  overviewHighlights: [
    "中国锂电出货量占全球 70%+，宁德时代市占率 37% 全球第一",
    "磷酸铁锂 vs 三元：前者便宜安全（比亚迪），后者续航更长（高端车）",
    "碳酸锂价格从 60 万/吨暴跌到 10 万/吨——锂矿不再稀缺，加工才是壁垒",
    "储能是下一个万亿赛道：把中午多余的太阳能存起来晚上用",
    "电池回收到 2030 年将形成千亿市场——'城市矿山'比挖矿更环保",
  ],
  rootNodes,
  childNodes,
  connections,
