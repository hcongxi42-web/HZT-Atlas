...
export const robotData: IndustryData = {
  ...
  overviewSummary: `人形机器人是"AI+制造"的终极载体。它像人一样有双腿、双臂和大脑，可以走进人类的工作和生活空间，完成从拧螺丝到叠衣服的各种任务。特斯拉的 Optimus、优必选的 Walker 等产品正在从实验室走向工厂车间。

2024 年被称为"人形机器人元年"。大语言模型让机器人有了"大脑"，核心零部件（减速器、电机、传感器）成本快速下降，工业制造场景率先落地。这或许是继 PC、手机、电动车之后，下一个改变世界的终端。`,
  overviewArchitecture: `本图谱按照"上游→中游→下游"三层架构组织：

• 上游——核心零部件：减速器是机器人的"关节"（把电机的高速旋转变成精准的低速动作）；电机是"肌肉"（驱动每个关节运动）；丝杠是"骨骼"（把旋转运动变成直线运动）；传感器是"感官"（力觉、视觉、触觉）；控制器和AI芯片是"大脑和神经系统"
• 中游——机器人本体制造：整机设计集成了所有零部件；人形机器人的运动控制和平衡是核心技术难点；灵巧手是机器人与环境交互的关键（抓取、操作）
• 下游——应用场景：工业制造（搬运、装配、质检）是目前最落地的场景；商业服务（导览、配送、清洁）在逐步渗透；家用陪伴和特种作业（救援、巡检）是远期方向`,
  overviewHighlights: [
    "特斯拉 Optimus 目标售价 2 万美元，马斯克称其将是'特斯拉最大的产品'",
    "行星滚柱丝杠是机器人精度最高的关节部件，单台机器人需要 14-28 根",
    "中国在人形机器人供应链上具有显著优势——电机、减速器产能全球第一",
    "2025 年多家企业进入量产阶段，工业搬运和装配是首批落地方向",
    "AI 大模型赋予机器人'常识推理'能力，让机器人从'编程执行'走向'自主决策'",
  ],
  rootNodes,
  childNodes,
  connections,
