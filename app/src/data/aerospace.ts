...
export const aerospaceData: IndustryData = {
  ...
  overviewSummary: `商业航天正在把"星辰大海"变成一门生意。过去航天是国家队的专属领地，现在 SpaceX、中国商业航天公司正在用市场化的方式降本增效——可回收火箭把发射成本打下来 90%，一箭多星让"拼车"发射成为日常。

中国商业航天 2023-2024 年发射次数全球第二，低轨卫星星座（对标 Starlink 的"星网"）正在加速组网。从卫星制造到火箭发射，从太空旅游到太空制造，这是一个从零到万亿的新赛道。`,
  overviewArchitecture: `本图谱按照"上游→中游→下游"三层架构组织：

• 上游——材料与燃料：航天材料（高温合金、钛合金、碳纤维）是火箭和卫星的"肌肉和骨骼"；推进剂是火箭的"火药"（液氧煤油、液氢液氧）；航天电子元器件需抗辐射、耐极端温度
• 中游——火箭与卫星：商业火箭（可回收运载火箭）是进入太空的"交通工具"；卫星制造（通信/遥感/导航）是太空经济的"基础设施"；发射服务提供"太空物流"
• 下游——太空应用：卫星通信让全球无死角上网（手机直连卫星）；卫星遥感提供地球观测数据（农业、气象、军事）；卫星导航（北斗/GPS）是位置服务的基石；太空旅游和太空制造是更遥远的未来`,
  overviewHighlights: [
    "中国商业航天 2024 年发射超 60 次，全球第二，仅次于美国",
    "可回收火箭是降成本的关键——SpaceX 已回收 300+ 次，中国正在追赶",
    "低轨卫星星座是太空'基建竞赛'：中国千帆星座计划发射超万颗卫星",
    "卫星互联网让手机直连卫星成为现实，2025 年起多家厂商开始支持",
    "商业航天被称为'太空经济'，全球市场规模预计 2040 年达 1 万亿美元",
  ],
  rootNodes,
  childNodes,
  connections,
