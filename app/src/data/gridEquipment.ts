...
export const gridEquipmentData: IndustryData = {
  ...
  overviewSummary: `电网设备是电力系统的"骨骼和血管"。发电厂发出的电不会自己跑到你家——需要变压器把电压升高（长途运输省损耗）、输电线路跨山越岭、再降压变回安全电压，这一路全靠电网设备支撑。

中国电网规模全球第一，特高压、智能电网、配网改造、充电桩建设正全面加速。全球能源转型下，电网投资额已超过电源投资，成为电力行业最大的增量市场。`,
  overviewArchitecture: `本图谱按照"上游→中游→下游"三层架构组织：

• 上游——原材料：硅钢是变压器的铁芯材料，决定能效等级；铜铝是电缆的导体材料；绝缘材料保证高压安全
• 中游——核心设备制造：变压器是电网的"心脏"（升压降压）；开关设备是电路的"闸门"（通断控制）；电缆是电力的"血管"；智能电表是电网的"神经末梢"（远程抄表）；电力电子设备用于电能质量治理
• 下游——应用场景：电网建设（特高压、主干网架）；配网改造（城市和农村配电网升级）；充电桩（服务电动车爆发增长）；数据中心和工业用电配套`,
  overviewHighlights: [
    "中国是全球最大的电网设备制造国和消费国，变压器出口全球占比超 40%",
    "十四五期间电网投资超 3 万亿元，配网和特高压是两大重点方向",
    "特高压变压器是世界上最复杂的电气设备之一，中国拥有完全自主技术",
    "新能源汽车爆发驱动充电桩建设，预计 2030 年充电桩数量超 2000 万个",
    "智能电表已覆盖超 5 亿户，中国建成全球最大的智能电网",
  ],
  rootNodes,
  childNodes,
  connections,
